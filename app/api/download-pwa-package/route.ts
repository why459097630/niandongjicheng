  ...
  try {
    ...
    zip.file(
      ...
      [
        ...
        "",
        "6. For push updates and reminders, customers should add the Customer Hub to their phone home screen and allow notifications when prompted.",
        "",
    ...
    zip.file(
      ...
      [
        ...
        "",
        "==================================================",
        "5. App Setup: Notifications and Home Screen",
        "==================================================",
        "",
        "Your Customer Hub has an App setup button inside the app.",
        "",
        "Tap the notification / app setup button, usually shown as a notification icon, to open the App setup panel.",
        "",
        "In the App setup panel, customers can:",
        "",
        "1. Enable notifications",
        "2. Add the Customer Hub to their phone home screen",
        "",
        "For notifications, tap Enable when prompted. If notifications are blocked, allow them in the browser or system settings.",
        "",
        "For home screen installation, tap Add if the Add button appears.",
        "",
        "On iPhone / Safari, tap the Share button, then choose Add to Home Screen.",
        "",
        "If notifications are not allowed, customers can still open the Customer Hub from the link or QR code, but push reminders may not be received.",
        "",
        "Customers do not need to download the Customer Hub from an app store.",
        "",
        "==================================================",
        "6. Important Notes",
        "==================================================",
